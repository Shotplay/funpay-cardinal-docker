...
variable "CARDINAL_REVISION" {
  default = "14a47dbb52ac2a0e1dd941902cf243cd20c442e0"
}
...
target "alpine" {
  inherits = ["_attest"]
  context = "./versions/0.1.17.9/alpine"
  dockerfile = "Dockerfile"
  tags = [
    "docker.io/shotplay/fp-cardinal:latest-alpine",
    "docker.io/shotplay/fp-cardinal:0.1.17.9-alpine",
...
target "distroless" {
  inherits = ["_attest"]
  context = "./versions/0.1.17.9/distroless"
  dockerfile = "Dockerfile"
  tags = [
    "docker.io/shotplay/fp-cardinal:latest-distroless",
    "docker.io/shotplay/fp-cardinal:0.1.17.9-distroless",
...
target "slim-bookworm" {
  inherits = ["_attest"]
  context = "./versions/0.1.17.9/slim-bookworm"
  dockerfile = "Dockerfile"
  tags = [
    "docker.io/shotplay/fp-cardinal:latest-slim-bookworm",
    "docker.io/shotplay/fp-cardinal:0.1.17.9-slim-bookworm",
...
target "slim-trixie" {
  inherits = ["_attest"]
  context = "./versions/0.1.17.9/slim-trixie"
  dockerfile = "Dockerfile"
  tags = [
    "docker.io/shotplay/fp-cardinal:latest",
    "docker.io/shotplay/fp-cardinal:latest-slim-trixie",
    "docker.io/shotplay/fp-cardinal:0.1.17.9-slim-trixie",
