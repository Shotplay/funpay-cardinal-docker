...
variable "CARDINAL_REVISION" {
  default = "65f5f431e3a1d9843a40414ec81e55b44cb08736"
}
...
target "alpine" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.14-alpine",
...
target "distroless" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.14-distroless",
...
target "slim-bookworm" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.14-slim-bookworm",
...
target "slim-trixie" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.14-slim-trixie",
