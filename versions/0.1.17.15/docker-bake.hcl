...
variable "CARDINAL_REVISION" {
  default = "c09dd13be25072bb3d5cdbba33d1e0d70e477710"
}
...
target "alpine" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.15-alpine",
...
target "distroless" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.15-distroless",
...
target "slim-bookworm" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.15-slim-bookworm",
...
target "slim-trixie" {
  ...
  tags = [
    ...
    "docker.io/shotplay/fp-cardinal:0.1.17.15-slim-trixie",
